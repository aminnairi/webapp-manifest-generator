...
$htmlmin --case-sensitive --collapse-boolean-attributes --collapse-inline-tag-whitespace --collapse-whitespace --conservative-collapse --decode-entities --quoteCharacter="'" --remove-attribute-quotes --remove-comments --remove-empty-attributes --remove-optional-tags --remove-redundant-attributes --remove-script-type-attributes --remove-style-link-type-attributes --remove-tag-whitespace ./src/static/index.html > ./dist/index.html
$uglify --output ./dist/index.js ./src/static/index.js
$uglifycss ./src/static/index.css > ./dist/index.css